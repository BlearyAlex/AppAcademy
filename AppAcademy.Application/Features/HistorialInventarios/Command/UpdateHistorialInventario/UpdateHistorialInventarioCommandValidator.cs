...
{
    public class UpdateHistorialInventarioCommandValidator : AbstractValidator<UpdateHistorialInventarioCommand>
    {
        public UpdateHistorialInventarioCommandValidator()
        {
